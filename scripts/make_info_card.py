...
ROWS = [
    ("host",),
    ("kv", "Now", "High School Student @ Skansaba"),
    ("kv", "Focus", "Low-Level Binary Exploitation"),
    ("kv", "Edu", "RPL, SMKN 1 Bantul"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Lang", "C#, Python, C/C++, JS, Bash"),
    ("kv", "Offensive", "Ghidra, IDA Pro, Burp Suite"),
    ("kv", "Vuln", "XXE, Path Traversal, Cmd Injection"),
    ("kv", "Dev", "Docker, .NET, Git"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Juara 3 LKS CyberSec 2026 (CTF)"),
    ("bul", "Kontributor write-up CSSC 2025"),
    ("bul", "Eco-Sorter Adventure - educational game"),
]
